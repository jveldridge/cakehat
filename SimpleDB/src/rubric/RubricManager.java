...
public class RubricManager {
     ...
     */
    public static void assignXMLToGrader(String asgn,
            String status, String studentAcct, String graderAcct,
            double designCheckScore) {
        String XMLTemplateFilePath = "/course/cs015/" + asgn + "/grade/grader_sheet.xml";

        String path = Constants.GRADER_PATH + graderAcct + "/" + asgn + "/" + studentAcct;
        String XMLGraderFilePath = path + ".xml";
