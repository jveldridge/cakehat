 ...
 * }
 * </pre>
 * This class stores information related to a user, despite its native name which would imply that it primarily dealt
...
public class NativeUserInformation extends Structure
{
     ...
     * <br/><br/>
     * Note: pw_gecos should contain the name; however, on OS X this information is actually stored in the pw_shell
     * variable.
     *
     * @return
     */
