...
class JavaActions implements ActionProvider
{
    ...
    /**
     * Deletes all compiled files in a group's project. It is safe to run
    ...
    /**
     * Returns a classpath with all of the jars that are in
     * <code>unarchiveDir</code> appended to <code>classpath</code>. If there
     * are no jars in <code>unarchiveDir</code> then unaltered classpath will
     * be returned.
     *
     * @param unarchiveDir
     * @param classpath may be <code>null</code>
     * @return
     * @throws ActionException
     */
    private static String addJarsToClasspath(File unarchiveDir, String classpath) throws ActionException
    {
        ...
        try
        {
            jarFiles = Allocator.getFileSystemUtilities().getFiles(unarchiveDir,
                    new FileExtensionFilter("jar"));
        }
        catch(IOException e)
        {
    ...
    private static void executeJavaInVisibleTerminal(ClassInfo mainClass,
            ...
            String runArgs, File unarchiveDir) throws ActionException
    {
        ...
        try
        {
            Allocator.getExternalProcessesUtilities()
                    .executeInVisibleTerminal(termName, javaCmd, unarchiveDir);
        }
        catch(IOException e)
        {
    ...
    /**
     * Returns information on all non-nested classes that have methods annotated
     * with JUnit's <code>org.junit.Test</code>.
     *
     * @param unarchiveDir
     * @return
     * @throws ActionException
    ...
    /**
     * Determines if <code>method</code> is annotated with JUnit's
     * <code>org.junit.Test</code> annotation.
     *
     * @param method
     * @return
     */
    ...
    private static class ClassInfo
    {
        ...
        /**
         * Fully qualified name of the class, e.g.
         * {@code org.apache.utils.IOHelper}
         *
         * @return
         */
        ...
        /**
         * If an anonymous class, must be a nested class to be an anonymous
         * class.
         *
         * @return
         */
