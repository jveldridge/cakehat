...
public class CourseInfoImplTest {
    ...
    /**
     * Verifies that the regex in getCourseFromPath is correct and only matches course titles that exist in the department.
     */
    @Test
    public void testGetCourseFromPath() {
        ...
        assertEquals(expected, CourseInfoImpl.getCourseFromPath(path));
