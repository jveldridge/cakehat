//package cakehat.views.newadmin;
//
...
//import cakehat.newdatabase.CakeHatDBIOException;
...
//    private GenericJComboBox<Part> _dpComboBox;
...
//
//    public ManualDistributorView(Assignment asgn, Part dp) {
...
//        try {
//            _tas = ImmutableList.copyOf(Allocator.getDataServicesV5().getTAs());
...
//     * @param initialPart the initial Part to be selected, may be
//     * <code>null</code>
//     *
//     * @return a JPanel to be shown at the top of the screen.
//     */
//    private JPanel getTopPanel(Assignment initialAsgn, Part initialPart) throws ServicesException {
//        JPanel topPanel = new JPanel();
//        topPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 0, 10));
//
//        _dpComboBox = new GenericJComboBox<Part>(initialAsgn.getParts(), new DescriptionProvider<Part>() {
//
//            @Override
//            public String getDisplayText(Part item) {
//                return item.getFullDisplayName();
//            }
//
//            @Override
//            public String getToolTipText(Part item) {
...
//        if (initialPart != null) {
//            _dpComboBox.setGenericSelectedItem(initialPart);
//        }
//        //Not specified, and the assignment has multiple parts
//        else if (initialAsgn.getParts().size() > 1) {
...
//            });
//        }
//        //Not specified, and the assignment has only one part
//        else {
//            _dpComboBox.setGenericSelectedItem(initialAsgn.getParts().get(0));
//        }
//
...
//        });
//
////        _asgnComboBox = new GenericJComboBox<Assignment>(Allocator.getDataServicesV5().getAssignments());
////        _asgnComboBox.setGenericSelectedItem(initialAsgn);
////
////        _asgnComboBox.addActionListener(new ActionListener() {
////            @Override
////            public void actionPerformed(ActionEvent e) {
////                List<Part> dps = _asgnComboBox.getSelectedItem().getParts();
...
//            try {
//                groups = Allocator.getDataServicesV5().getAssignedGroups(_dpComboBox.getSelectedItem(), selectedTA);
//            } catch (ServicesException ex) {
...
//            _distribution = null;
//            try {
//                _distribution = Allocator.getDataServicesV5().getDistribution(_dpComboBox.getSelectedItem());
//            } catch (ServicesException ex) {
