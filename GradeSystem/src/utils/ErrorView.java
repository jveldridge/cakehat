...
public class ErrorView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jCheckBox1.isSelected()) {
            Utils.sendMail(Utils.getUserLogin(), Utils.getUserName(Utils.getUserLogin()), new String[]{Constants.GRADES_TA + "@" + Constants.EMAIL_DOMAIN, Constants.GRADES_HTA + "@" + Constants.EMAIL_DOMAIN}, new String[0], new String[0], "Grading System Error", "[This is an autogenerated message] \n\n" + jTextArea2.getText() + "\n\n" + jTextArea1.getText(), new String[0]);
        }
        this.dispose();
