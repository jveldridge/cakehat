...
public class Constants {
    ...
    public static final String DATABASE_DIR = "/home/psastras/cs15db.db"; //COURSE_DIR + "tabin/gradesys/cs015Database.db";//"/home/psastras/cs15db.db";///COURSE_DIR + "tabin/gradesys/cs015Database.db";
}