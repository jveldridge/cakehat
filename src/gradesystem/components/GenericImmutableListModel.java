...
/**
 * A generic list model that does not provide a means for its contents to be
 * mutated.
 *
 * @author jak2
 */
public class GenericImmutableListModel<T> extends GenericAbstractListModel<T>
{
    ...
    {
        //Implementation note: this code intentionally does not use Google
        //Collection's ImmutableList because it does not support the list
        //containg null
